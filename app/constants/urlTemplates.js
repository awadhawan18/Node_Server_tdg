...
module.exports = {
	...
	PRODUCT_BOOKING : {url:'/plan/quote', method: 'POST'},

	FETCH_PRICE : {url:'/payment/price', method: 'GET'},
	FETCH_DEAL : {url:'/price/group', method: 'GET'},

	FIND_ITINERARY : {url:'/itinerary', method : 'GET'},
	ROUTE_INFO : {url:'/itinerary/info', method : 'GET'},
	FIND_ROUTE : {url:'/route', method : 'GET'},
	ACTIVE_ROUTES_FROM : {url:'/route/from', method : 'GET'},
	ITINERARY : {url:'/itinerary/itinerary/{mongo_id}', method : 'GET'},
	...
	//booking calls
	CREATE_BOOKING : {url: '/payment/book', method: 'POST'},
